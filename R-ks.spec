...
Version  : 1.11.7
Release  : 23
URL      : https://cran.r-project.org/src/contrib/ks_1.11.7.tar.gz
Source0  : https://cran.r-project.org/src/contrib/ks_1.11.7.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1581447792
