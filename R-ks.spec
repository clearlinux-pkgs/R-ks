...
Version  : 1.11.2
Release  : 1
URL      : https://cran.r-project.org/src/contrib/ks_1.11.2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/ks_1.11.2.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1530490435
